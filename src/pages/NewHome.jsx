...
export default function NewHome() {
    ...
    const scrollRef = useRef(null);
      ...
      useEffect(() => {
        const backgroundUrl = "	https://html.xpressbuddy.com/e.visa/assets/img/bg/hero_bg.jpg";
    ...
    'https://www.goforen.com//uploads/gallery/96-image.png'
      ...
      // data-background img end
        ...
        useEffect(() => {
          const backgroundUrl2 = "	https://html.xpressbuddy.com/e.visa/assets/img/service/img_01.jpg";
        ...
        // data-background img end
         ...
         useEffect(() => {
           const backgroundUrl3 = "https://html.xpressbuddy.com/e.visa/assets/img/bg/counter_bg.jpg";
  ...
  return (
    <div>
      <Navbar />
      {/* <!-- hero start --> */}
        <section className="hero hero__style-one bg_img"  style={{ 
...
>
                ...
                <div className="row align-items-center">
                    <div className="col-xl-6 col-lg-7">
                        <div className="hero__content">
                            <h1 className="wow skewIn">Get a free assessment /<br/>advice</h1>
                            <p className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration=".6s">Fill up a quick inquiry form / Upload your cv and we will help you out with your queries!</p>
                            
                            <div className="btns wow fadeInUp mt-5" data-wow-delay="600ms" data-wow-duration=".6s">
                                <a className="thm-btn" href="/Contact">Quick Inquiry</a>
                                <a className="thm-btn thm-btn--white" href="/Upload-cv">Upload CV</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {/* <!-- package start --> */}
        <section class="package package-bg pos-rel pt-120 pb-120"  style={{ 
                ...
                <div class="row mt-none-30 d-flex justify-content-center">
                        ...
                        <div class="xb-package mt-30">
                            <div class="xb-item--inner">
                                ...
                                <div class="xb-item--img">
                                    <a href="#!" style={{display:'flex',justifyContent:'center'}}><img src="/assets/pic/visanews.png" alt=""  width={"300px"}/></a>
                                </div>
                                 <div className="scroll-container mt-3" id="scrollBox">
                          <div className="scroll-inner" ref={scrollRef}>
                            {extendedItems.map((text, i) => (
                              <div className="scroll-item" key={i}>
                                <div className="xb-item--description" style={{fontSize:'14px',textAlign:'center'}}>{text}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                        <div style={{display:'flex',justifyContent:'center',marginTop:'10px' }}>
                            <button style={{padding:'10px 20px',background:'#00cc99',borderRadius:'10px'}}><a style={{color:'#fff'}} href="/News">View All</a></button>
                        </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="xb-package mt-30">
                            <div class="xb-item--inner">
                                <div class="xb-item--img">
                                    <a href="#!"><img src="/assets/pic/Plane-on-takeoff.webp" alt="" /></a>
                                </div>
                                <div class="xb-item--holder">
                                   
                                    <h2 class="xb-item--title ul_li_center mb-2"><a href="#!">ACTIVITIES</a></h2>
    ...
    backgroundPosition: 'center'
                    ...
                    <div className="sec-title wow skewIn pt-120">
                        ...
                        <p>Explore a wide range of career-focused courses tailored <br /> to help you qualify for your desired visa destination.</p>
                    </div>
                        ...
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-service">
                                <div className="xb-item--inner">
                                    ...
                                    <div className="xb-item--holder">
                                        <h3 className="xb-item--title mb-20"><a href="/TOEFLIBT">TOEFL IBT</a></h3>
                                        <div className="xb-item--description">
                        ...
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-service">
                                <div className="xb-item--inner">
                                    ...
                                    <div className="xb-item--holder">
                                        <h3 className="xb-item--title mb-20"><a href="/GRE">GRE</a>
                                        </h3>
                                        <div className="xb-item--description">
                                        Achieve your academic and career goals with the GRE, essential for graduate admissions globally.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-service">
                                <div className="xb-item--inner">
                                    ...
                                    <div className="xb-item--holder">
                                        <h3 className="xb-item--title mb-20"><a href="/PTE"> PTE</a></h3>
                                        <div className="xb-item--description">
                        ...
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-service">
                                <div className="xb-item--inner">
                                    ...
                                    <div className="xb-item--holder">
                                        <h3 className="xb-item--title mb-20"><a href="/SAT">SAT</a>
                                        </h3>
                                        <div className="xb-item--description">
                                        Open doors to top international universities with strong SAT scores designed for undergraduate programs.
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section className="about pos-rel pb-130">
            <div className="container">
                <div className="sec-title mb-55">
                    <h2 className="mb-30 wow skewIn">Why Us
                       </h2>
                <p>GO FOREN offers services for immigration/PR visas, student visas, visitor visas, <br /> and business/entrepreneur visas. We provide complete support — from counseling <br /> and application to visa processing. Our assistance also includes air ticketing, foreign <br /> exchange, travel insurance, accommodation, and airport transfers, ensuring a smooth <br /> transition to your new country</p>
                </div>
                <div className="row align-items-center">
                            ...
                            <ul className="about-list ul_li list-unstyled">
                                <li>
                                    ...
                                    <div className="xb-item--inner">
                                        ...
                                        <div className="xb-item--holder">
                                            <h3 className="xb-item--title mb-10">Immigration - PR Visa</h3>
                                            <div className="xb-item--description">
                                ...
                                <li>
                                    ...
                                    <div className="xb-item--inner">
                                        ...
                                        <div className="xb-item--holder">
                                            <h3 className="xb-item--title mb-10">Investor Visa</h3>
                                            <div className="xb-item--description">
                                ...
                                <li>
                                    ...
                                    <div className="xb-item--inner">
                                        ...
                                        <div className="xb-item--holder">
                                            <h3 className="xb-item--title mb-10">Work Permit Visa</h3>
                                            <div className="xb-item--description">
            ...
            <div className="about__img">
                <img src="	https://html.xpressbuddy.com/e.visa/assets/img/about/about_img.png" alt="" />
            </div>
        </section>
        {/* <!-- about end --> */}
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                            <div class="xb-team text-center">
                                <div class="xb-item--inner" data-parallax='{"scale" : 1}'>
                                    ...
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--name"><a href="">Janvi Patel</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                            <div class="xb-team text-center">
                                <div class="xb-item--inner">
                                    ...
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--name"><a href="">Vivek Sharma</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                            <div class="xb-team text-center">
                                <div class="xb-item--inner">
                                    ...
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--name"><a href="">Kunal Mehta</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                            <div class="xb-team text-center">
                                <div class="xb-item--inner">
                                    ...
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--name"><a href="">Krishna Varma</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                            <div class="xb-team text-center">
                                <div class="xb-item--inner">
                                    ...
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--name"><a href="">Jay Patel</a></h3>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                            <div class="xb-team text-center">
                                <div class="xb-item--inner">
                                    ...
                                    <div class="xb-item--holder">
                                        <h3 class="xb-item--name"><a href="">Drashti Vora</a></h3>
          ...
          <div className="col-lg-5">
            <div className="xb-faq-content">
              <div className="sec-title mb-125">
                ...
                <p>At the heart of our commitment to providing <br /> exceptional immigration solutions stands our trusted</p>
              </div>
            ...
            <div className="container">
                <div className="blog-wrap">
                    <div className="sec-title mb-60 text-center">
                        ...
                        <p style={{textAlign:'center'}}>Explore the most recent addition to our informative articles</p>
                    </div>
                    <div className="row justify-content-md-center mt-none-30">
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-blog">
                                <div className="xb-item--inner">
                                    ...
                                    <div className="xb-item--holder">
                                        ...
                                        <h3 className="xb-item--title border-effect"><a href="/Blog">A PR Visa allows you to live and work in ...</a></h3>
                                        <a className="xb-item--link" href="/Blog">Read More<span><img
                        ...
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-blog">
                                <div className="xb-item--inner">
                                    <div className="xb-item--img">
                                        <a href="/Blog"><img src="assets/img/blog/img_02.jpg" alt="" /></a>
                                    </div>
                                    <div className="xb-item--holder">
                                        <a className="xb-item--category color-2" href="#!">STUDENT VISA</a>
                                        
                                        <h3 className="xb-item--title border-effect"><a href="/Blog">A Student Visa allows you to study full-time in  ..</a></h3>
                                        <a className="xb-item--link" href="/Blog">Read More<span><img
                                                src="assets/img/icon/right_arrow.svg" alt="" /></span></a>
                                    </div>
                                    <a className="xb-overlay xb-overlay-link" href="/Blog"></a>
                        ...
                        <div className="col-lg-4 col-md-6 mt-30">
                            <div className="xb-blog">
                                <div className="xb-item--inner">
                                    <div className="xb-item--img">
                                        <a href="/Blog"><img src="assets/img/blog/img_03.jpg" alt="" /></a>
                                    </div>
                                    <div className="xb-item--holder">
                                        <a className="xb-item--category color-3" href="#!">INVESTOR VISA</a>
                                        
                                        <h3 className="xb-item--title border-effect"><a href="/Blog">An Investor Visa allows individuals to obtain ..</a></h3>
                                        <a className="xb-item--link" href="/Blog">Read More<span><img
                                                src="assets/img/icon/right_arrow.svg" alt="" /></span></a>
                                    </div>
                                    <a className="xb-overlay xb-overlay-link" href="/Blog"></a>
                    ...
                    <div className="xb-blog-bg"   style={{ 
