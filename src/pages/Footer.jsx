                ...
                <div className="col-lg-3 mt-30 col-md-6 footer__custom-col">
                    <div className="footer__widget">
                        ...
                        <ul className="footer__cta list-unstyled mt-50">
                            <li className="ul_li"><span><img src="assets/img/icon/f_call.svg" alt="" /> </span>+91590 088 55
                            </li>
                            <li className="ul_li"><span><img src="assets/img/icon/f_mail.svg" alt="" /></span>e.visa@gmail.com
                            </li>
                        </ul>
                    </div>
                </div>
