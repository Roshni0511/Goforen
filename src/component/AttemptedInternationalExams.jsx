...
export default function AttemptedInternationalExams() {
                  ...
                  <form>
                    ...
                    <div>
                      ...
                      <div className="col-12 mt-4">
                        <label htmlFor="">Marks In English Language At 10th / 12th Exam :</label>
                        <div className="xb-item--field">
                          
                          <input
                          style={{border:'1px solid #edf3f5',borderRadius:'10px'}}
                            type="text"
